...
export default function Dashboard() {
  ...
  const renderStudentDashboard = () => {
    ...
    const totalMediaCount = studentCollections?.reduce((total, collection) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Video Collections</p>
                <p className="text-2xl font-bold text-gray-900">
                  {collectionsLoading ? "..." : collectionsError ? "Error" : (studentCollections?.length || 0)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Coaching Notes</p>
                <p className="text-2xl font-bold text-gray-900">
                  {collectionsLoading ? "..." : collectionsError ? "Error" : "N/A"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {collectionsLoading ? "..." : collectionsError ? "Error" : totalMediaCount}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Create a new video collection</p>
              </div>
            </a>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {mediaLoading ? "..." : mediaError ? "Error" : (allMedia?.reduce((total, media) => total + (media.coachingNotes?.length || 0), 0) || 0)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {metricsLoading ? "..." : metricsError ? "Error" : (dashboardMetrics?.weeklyNotesCount ?? 0)}
              </p>
            </div>
          </div>
        </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {allMedia.map((media) => (
                  <tr key={media.mediaId} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{media.collection.title}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {metricsLoading ? "..." : metricsError ? "Error" : (dashboardMetrics?.studentCount ?? "N/A")}
              </p>
            </div>
          </div>
        </div>
