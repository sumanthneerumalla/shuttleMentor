...
export function CoachesListing() {
  ...
  const [sortOrder, setSortOrder] = useState<GetCoachesInput['sortOrder']>('desc');
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            ...
            onChange={(e) => {
              const [newSortBy, newSortOrder] = e.target.value.split('_') as [GetCoachesInput['sortBy'], GetCoachesInput['sortOrder']];
              setSortBy(newSortBy);
