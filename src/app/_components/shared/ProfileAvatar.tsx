      ...
      {imageUrl ? (
        <AvatarImage 
          ...
          onError={() => {
            ...
            const img = document.querySelector(`img[alt="${alt}"]`) as HTMLImageElement | null;
            if (img) img.style.display = 'none';
          }} 
        />
      ) : null}
      <AvatarFallback className={`${getColorClass(name)} text-white flex items-center justify-center ${fontSizeClass}`}>
        {initials}
      </AvatarFallback>
    </Avatar>
  );
